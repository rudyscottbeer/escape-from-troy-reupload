 ...
 */
package com.mygdx.technicalprototype.physics.platform;
...
public class Spinner extends ComplexObstacle {
	...
	public Spinner(JsonValue data, float width, float height) {
		...
		// Name: "pin"
		pivot = new WheelObstacle(data.get("pos").getFloat(0),data.get("pos").getFloat(1),data.getFloat("radius"));
		pivot.setName("pin");
		pivot.setDensity(data.getFloat("low_density"));
