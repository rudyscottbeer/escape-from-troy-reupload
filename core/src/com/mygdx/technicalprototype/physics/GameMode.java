 ...
 */
package com.mygdx.technicalprototype.physics;
 ...
 */
public abstract class GameMode implements Screen {
	/** The texture for walls and platforms */
	protected TextureRegion earthTile;
	/** The texture for the exit condition */
	protected TextureRegion goalTile;
	/** The texture for the entry condition */
	protected TextureRegion entryTile;
	...
	protected boolean toFailed = false;
