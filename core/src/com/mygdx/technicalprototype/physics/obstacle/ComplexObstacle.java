 ...
 */
package com.mygdx.technicalprototype.physics.obstacle;
 ...
 */
public abstract class ComplexObstacle extends GameObject {
	...
	public Vector2 getVelocity() {
		return (body != null ? body.getLinearVelocity() : super.getVelocity());
	}
